	...
	private boolean paused = false;
	   public AudioDevice(String threadName)
	   {
	      ...
	      track = new AudioTrack( AudioManager.STREAM_MUSIC, 44100, 
	       ...
	       theProducer = new ManyChipUpdateThread("updateThread");
	   }	   
	 
	   private ManyChipUpdateThread theProducer; 

	   public AudioDevice( String threadName, ManyChipUpdateThread producer ) 
	   { 
	      setName( threadName ); 
